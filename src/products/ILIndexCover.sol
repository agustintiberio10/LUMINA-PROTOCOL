 ...
 *   verifiedPrice = TWAP 15 min of ETH/USD at settlement time.
 ...
 */
contract ILIndexCover is BaseShield {
    ...
    function _doVerifyAndCalculate(
        ...
        // [FIX] Decode oracle proof WITH asset identifier (TWAP 15 min at settlement time)
        ...
        // [FIX] Verify signature WITH asset included in hash
