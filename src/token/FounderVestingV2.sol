...
/// @notice [Sprint Z.2] 8M LUMINA locked until AltSeason conditions or 3-year fallback.
/// @dev    Re-deploy of FounderVesting with corrected oracle wiring (LuminaOracleV2 SET A)
///         and updated tuning:
///           - SUSTAINED_DURATION:  7d → 1d
///           - FALLBACK_DURATION:   1460d (4y) → 1095d (3y)
///         All other semantics identical to v1.
///         Conditions (2-of-3 sustained 1 day):
///           A: ETH/BTC > 0.050
///           B: ETH > $4,000
...
contract FounderVestingV2 is Ownable {
    ...
    uint256 public constant SUSTAINED_DURATION = 1 days; // [Z.2] tightened from 7 days
    uint256 public constant TRANCHE_INTERVAL = 31 days;
    uint256 public constant TOTAL_TRANCHES = 3;
    uint256 public constant FALLBACK_DURATION = 1095 days; // [Z.2] 3 years (was 1460 = 4y)
