...
contract CoverRouterUpgradeTest is Test {
    ...
    function setUp() public {
        ...
        bytes memory routerInit =
            abi.encodeCall(CoverRouter.initialize, (owner, oracle, phala, address(pm), usdc, false, feeReceiver, 300));
    ...
    function test_updateProductShield_productIdMismatch_reverts() public {
        vm.prank(owner);
        vm.expectRevert(abi.encodeWithSelector(CoverRouter.ProductIdMismatch.selector, DEPEG_ID, OTHER_ID));
