 ...
 *
 * Usage:
 *   forge script script/TestPurchase.s.sol:TestPurchase \
...
contract TestPurchase is Script {
    ...
    // ── Policy parameters ─────────────────────────────────────────
    uint256 constant COVERAGE_AMOUNT = 1_000_000_000; // $1,000 in 6 decimals
    ...
    function run() external {
        ...
        uint256 premiumAmount = _calculatePremium(
            COVERAGE_AMOUNT, P_BASE_BPS, RISK_MULT_BPS, DURATION_DISCOUNT_BPS, vs.utilizationBps, DURATION_SECONDS
        );
