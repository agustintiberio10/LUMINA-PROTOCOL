...
/// @title EchidnaFounderVesting
/// @notice Sprint Z.1 — property-based fuzzing for the FounderVesting immutable.
///         Echidna invariants verified over 100k+ random sequences of state mutations.
contract EchidnaFounderVesting {
    ...
    constructor() {
        ...
        vesting = new FounderVesting(address(oracle), address(aavePool), address(lumina), usdc, address(this));
    ...
    ///         (Captured implicitly: triggerTimestamp set once when altSeasonTriggered flips true.)
