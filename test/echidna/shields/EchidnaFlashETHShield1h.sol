...
/// @title EchidnaFlashETHShield1h
/// @notice Echidna property suite for FlashETHShield1h (Sprint EE Phase B).
...
contract EchidnaFlashETHShield1h {
    ...
    constructor() {
        ...
        bytes memory initData = abi.encodeWithSelector(FlashETHShield1h.initialize.selector, ROUTER, address(oracle));
        ERC1967Proxy proxy = new ERC1967Proxy(address(impl), initData);
        shield = FlashETHShield1h(address(proxy));
