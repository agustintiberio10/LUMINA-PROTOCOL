...
/// @title EchidnaFlashBTCShield4h
/// @notice Echidna property suite for FlashBTCShield4h (Sprint EE Phase B).
...
contract EchidnaFlashBTCShield4h {
    ...
    constructor() {
        ...
        bytes memory initData = abi.encodeWithSelector(FlashBTCShield4h.initialize.selector, ROUTER, address(oracle));
        ERC1967Proxy proxy = new ERC1967Proxy(address(impl), initData);
        shield = FlashBTCShield4h(address(proxy));
