...
/// @title EchidnaFlashETHShield48h
/// @notice Echidna property suite for FlashETHShield48h (Sprint EE Phase B).
...
contract EchidnaFlashETHShield48h {
    ...
    constructor() {
        ...
        bytes memory initData = abi.encodeWithSelector(FlashETHShield48h.initialize.selector, ROUTER, address(oracle));
        ERC1967Proxy proxy = new ERC1967Proxy(address(impl), initData);
        shield = FlashETHShield48h(address(proxy));
