...
/// @title EchidnaFlashETHShield24h
/// @notice Echidna property suite for FlashETHShield24h (Sprint EE Phase B).
...
contract EchidnaFlashETHShield24h {
    ...
    constructor() {
        ...
        bytes memory initData = abi.encodeWithSelector(FlashETHShield24h.initialize.selector, ROUTER, address(oracle));
        ERC1967Proxy proxy = new ERC1967Proxy(address(impl), initData);
        shield = FlashETHShield24h(address(proxy));
