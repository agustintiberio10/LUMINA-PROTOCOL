...
/// @title EchidnaFlashBTCShield48h
/// @notice Echidna property suite for FlashBTCShield48h (Sprint EE Phase B).
...
contract EchidnaFlashBTCShield48h {
    ...
    constructor() {
        ...
        bytes memory initData = abi.encodeWithSelector(FlashBTCShield48h.initialize.selector, ROUTER, address(oracle));
        ERC1967Proxy proxy = new ERC1967Proxy(address(impl), initData);
        shield = FlashBTCShield48h(address(proxy));
