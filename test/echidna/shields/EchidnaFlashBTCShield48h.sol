...
/// @title EchidnaFlashBTCShield48h — Sprint T-30a Phase F
/// @notice Property scaffold for the BTC 48h / 10% flash shield.
...
contract EchidnaFlashBTCShield48h {
    ...
    uint16 internal constant TRIGGER_DROP_BPS = 1000;
