...
- **2026-05-26 (Sprint 7.6 Operational Security Audit)**: 16 findings operacionales abiertos (1 CRIT, 4 HIGH, 7 MED, 3 LOW, 1 INFO) — report `audit-pack/audits/2026-05-26-operational-audit-v53.md`. **Mainnet blockers operacionales nuevos/reafirmados**: **OP-001** rotar keys + ejecutar KEY-ROTATION-PLAN (priv-key founder en plaintext, NO rotada) [CRIT]; **OP-002** branch protection en `main` + CODEOWNERS + CI-as-merge-gate [HIGH]; **OP-003/009** Gnosis Safe + TimelockController (=BL-MULTISIG) + ownership transfer + timelocked upgrades [HIGH]; **OP-004/007/008** on-call real + pager + monitoring live + rehearsal de runbooks P0 [HIGH]; **OP-005** refrescar SECURITY.md (scope obsoleto) + bounty tiers; **OP-011** manifests stale V5.0 → usar canónico PR#160. Score 6.0/10 NEEDS-HARDENING; mainnet timeline 4-6 semanas. Fase 5 testnet OK. PR `feat/audit-7-6-operational-v1`.
