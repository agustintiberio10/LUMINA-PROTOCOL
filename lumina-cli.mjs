  ...
  en: {
    ...
    sections: [
      ...
      [
        ...
        `  ${CYAN}119${RESET} tests passing    |  ${CYAN}48h${RESET} timelock       |  ${CYAN}1-of-1 (planned 2-of-3)${RESET} multisig`,
        ``,
      ...
      [
        ...
        `  ${GRAY}Duration:${RESET}   ${WHITE}7-30 days${RESET}  ${GRAY}| Waiting: 1 hour${RESET}`,
      ...
      [
        ...
        `${CYAN}VolatileShort${RESET}       ${WHITE}37 days${RESET}     ${GRAY}BSS + IL Index${RESET}          ${GREEN}12-16%${RESET}`,
        `${CYAN}VolatileLong${RESET}        ${WHITE}97 days${RESET}     ${GRAY}IL long + BSS overflow${RESET}  ${GREEN}15-19%${RESET}`,
        `${CYAN}StableShort${RESET}         ${WHITE}97 days${RESET}     ${GRAY}Depeg short${RESET}             ${GREEN}11-15%${RESET}`,
        `${CYAN}StableLong${RESET}          ${WHITE}372 days${RESET}   ${GRAY}Depeg + Exploit${RESET}         ${GREEN}18-27%${RESET}`,
        ``,
      ...
      [
        ...
        `  ${GRAY}80%:${RESET} ${YELLOW}1.50x${RESET}  ${GRAY}85%:${RESET} ${YELLOW}2.25x${RESET}  ${GRAY}90%:${RESET} ${RED}3.75x${RESET}  ${GRAY}95%:${RESET} ${RED}REJECT${RESET}`,
      ],
    ],
  },
  es: {
    ...
    sections: [
      ...
      [
        ...
        `  ${CYAN}119${RESET} tests pasando      |  ${CYAN}48h${RESET} timelock      |  ${CYAN}1-of-1 (planned 2-of-3)${RESET} multisig`,
        ``,
      ...
      [
        ...
        `  ${GRAY}Duracion:${RESET}   ${WHITE}7-30 dias${RESET}  ${GRAY}| Waiting: 1 hora${RESET}`,
      ...
      [
        ...
        `${CYAN}VolatileShort${RESET}       ${WHITE}37 dias${RESET}     ${GRAY}BSS + IL Index${RESET}          ${GREEN}12-16%${RESET}`,
        `${CYAN}VolatileLong${RESET}        ${WHITE}97 dias${RESET}     ${GRAY}IL largo + BSS overflow${RESET} ${GREEN}15-19%${RESET}`,
        `${CYAN}StableShort${RESET}         ${WHITE}97 dias${RESET}     ${GRAY}Depeg corto${RESET}             ${GREEN}11-15%${RESET}`,
        `${CYAN}StableLong${RESET}          ${WHITE}372 dias${RESET}   ${GRAY}Depeg + Exploit${RESET}         ${GREEN}18-27%${RESET}`,
        ``,
      ...
      [
        ...
        `  ${GRAY}0%:${RESET} ${WHITE}1.00x${RESET}  ${GRAY}20%:${RESET} ${WHITE}1.13x${RESET}  ${GRAY}40%:${RESET} ${WHITE}1.25x${RESET}  ${GRAY}60%:${RESET} ${WHITE}1.38x${RESET}`,
        `  ${GRAY}80%:${RESET} ${YELLOW}1.50x${RESET}  ${GRAY}85%:${RESET} ${YELLOW}2.25x${RESET}  ${GRAY}90%:${RESET} ${RED}3.75x${RESET}  ${GRAY}95%:${RESET} ${RED}RECHAZADO${RESET}`,
      ],
    ],
  },
}
